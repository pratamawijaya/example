...
public class HomeViewPresenter {
    ...
    private final String RAISA_URL = "http://urbanradiobandung.com/home/wp-content/uploads/2015/06/raisa.jpg";
    ...
    public void setupFragment() {
        ...
        fragmentHomeItems.add(new FragmentHomeItem("BBM Chat", new BBMChatFragment(), R.drawable.ic_chat_white_24dp));
        fragmentHomeItems.add(new FragmentHomeItem("BBM Feeds", new BBMFeedFragment(), R.drawable.ic_cloud_white_24dp));
        fragmentHomeItems.add(new FragmentHomeItem("BBM Contact", new BBMContactFragment(), R.drawable.ic_person_white_24dp));
        fragmentHomeItems.add(new FragmentHomeItem("BBM Groups", new BBMGroupFragment(), R.drawable.ic_group_white_24dp));

        view.setupViewPager(fragmentHomeItems);
    }

    public void loadDataUser(Context context, ImageView userPicture, TextView userName, TextView userStatus) {
